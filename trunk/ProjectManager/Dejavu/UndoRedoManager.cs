...
namespace DejaVu
{
    ...
    public static class UndoRedoManager
    {
		...
		///////////////////////////////////////////
        ////add by weiyuanke@139.com
        //////////////////////////
        public static event EventHandler<MemberChangedEventArgs> MemberChanged;

        public static void PassOnMsg(object sender, MemberChangedEventArgs arg) {
            if (UndoRedoManager.MemberChanged != null) {
                UndoRedoManager.MemberChanged(sender, arg);
            }
        }
