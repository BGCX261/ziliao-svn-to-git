...
namespace TDK.Core.Logic.DAL
{
	public partial class Cld_FCBlockCRUD
	{
		...
		public IList<Cld_FCBlock> Load_Blocks(string wherestring)
		{
			...
			try
			{
                blocks = this.session.CreateSQLQuery(sql).AddEntity("TDK.Core.Logic.DAL.Cld_FCBlock").List<Cld_FCBlock>();
				transacton.Commit();
			}
			catch (Exception e)
			{
		...
		public IList<Cld_FCInput> Get_FCInput_List(string whereString)
		{
			return null;
		}

		public IList<Cld_FCOutput> Get_FCOutput_List(string whereString)
		{
			return null;
		}

		public IList<Cld_FCParameter> Get_FCParameter_List(string whereString)
		{
			return null;
		}
		/// <summary>
